...
const lesson11Words = [
  { armenian: 'Տապան', phonetic: 'tapan', translation: 'Ковчег', example_armenian: 'Նոյյան տապան:', example_translation: 'Ноев ковчег.' },
  { armenian: 'Կենդանի', phonetic: 'kendani', translation: 'Живой, животное', example_armenian: 'Սիրուն կենդանի:', example_translation: 'Красивое животное.' },
  { armenian: 'Թռչուն', phonetic: 'trchun', translation: 'Птица', example_armenian: 'Թռչունը թռչում է:', example_translation: 'Птица летит.' },
  { armenian: 'Զույգ', phonetic: 'zuyg', translation: 'Пара', example_armenian: 'Մեկ զույգ կոշիկ:', example_translation: 'Одна пара обуви.' },
  { armenian: 'Սխալ', phonetic: 'skhal', translation: 'Ошибка, неправильно', example_armenian: 'Սա սխալ չէ:', example_translation: 'Это не ошибка.' },
];

async function main() {
  console.log(`Starting import of ${lesson11Words.length} words for Lesson 11 (Part 1)...`);

  for (const item of lesson11Words) {
  ...
  console.log(`Lesson 11 words: ${counts.rows[0].lesson_11}`);
