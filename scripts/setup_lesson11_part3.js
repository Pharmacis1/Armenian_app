...
const lesson11Part3Words = [
  { armenian: 'Ոչնչացնել', phonetic: 'vochnchacnel', translation: 'Уничтожить', example_armenian: 'Ոչնչացնել փաստաթղթերը:', example_translation: 'Уничтожить документы.' },
  { armenian: 'Փոշմանել', phonetic: 'poshmanel', translation: 'Сожалеть, передумать', example_armenian: 'Ես չեմ փոշմանել:', example_translation: 'Я не пожалел / не передумал.' },
  { armenian: 'Կանչել', phonetic: 'kanchel', translation: 'Звать, позвать', example_armenian: 'Բժիշկ կանչել:', example_translation: 'Вызвать / позвать врача.' },
  { armenian: 'Պատվիրել', phonetic: 'patvirel', translation: 'Заказать, поручить', example_armenian: 'Սուրճ պատվիրել:', example_translation: 'Заказать кофе.' },
];

async function main() {
  console.log(`Starting import of ${lesson11Part3Words.length} words for Lesson 11 (Part 3)...`);

  for (const item of lesson11Part3Words) {
  ...
  console.log('\n🎉 Lesson 11 Part 3 setup complete:');
